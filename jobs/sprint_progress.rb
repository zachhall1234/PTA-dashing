...
SCHEDULER.every '10s', :first_in => 0 do |job|
  client = JIRA::Client.new({
    ...
    closed_points = client.Issue.jql("project = OPP and sprint in openSprints() and status = \"accepted\"").size || 0
  ...
  send_event('p800-payments-sprint', { title: "Sprint Ticket Progress", min: 0, value: percentage, max: 100, moreinfo: moreinfo })
